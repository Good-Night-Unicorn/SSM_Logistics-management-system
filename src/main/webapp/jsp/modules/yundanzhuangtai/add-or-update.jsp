    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑运单状态</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑运单状态</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">运单状态信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yunshuchengbenId" name="yunshuchengbenId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>目前状态</label>
                                        <input id="yundanzhuangtaiGongsi" name="yundanzhuangtaiGongsi" class="form-control"
                                               placeholder="目前状态">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            let data = {};
            getContent();
            if(window.sessionStorage.getItem('role') != '运单状态'){//当前登录用户不为这个
            ...
            httpJson("yundanzhuangtai/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyundanzhuangtai');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yundanzhuangtaiGongsi: "required",
                updateTime: "required",
            },
            messages: {
                yunshuchengbenId: "承运单号不能为空",
                yundanzhuangtaiGongsi: "目前状态不能为空",
                updateTime: "更新时间不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addyundanzhuangtai = window.sessionStorage.getItem("addyundanzhuangtai");
        if (addyundanzhuangtai != null && addyundanzhuangtai != "" && addyundanzhuangtai != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("yundanzhuangtai/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yundanzhuangtaiGongsi").val(ruleForm.yundanzhuangtaiGongsi);
